...
Smoke_Box <- ggplot(odata, aes(x=SMOKE, y=bmi, group=SMOKE, fill=SMOKE)) + geom_boxplot() + scale_fill_brewer(palette = "Blues")  + xlab("Smoking Status")+ ylab("BMI") + ggtitle("Box Plot of BMI vs. Smoking Status") 
...
kmeansclust %>% ggplot(aes(SMOKE.binary,bmi, fill=cluster)) + geom_boxplot() + ggtitle("Kmeans Clustering of Smoke Status Data") +  scale_fill_brewer(palette="Blues")
